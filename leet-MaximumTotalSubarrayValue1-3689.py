...
def main():
    thingy = Solution()
    assert thingy.maxTotalValue( nums = [1,3,2], k = 2) == 4, "Test Case Failed"
    assert thingy.maxTotalValue([4,2,5,1], k = 3) == 12, "Test Case Failed"
    # assert thingy.maxTotalValue() == 7, "Test Case Failed"
    # assert thingy.maxTotalValue() == 7, "Test Case Failed"
