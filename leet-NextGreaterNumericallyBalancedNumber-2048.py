...
def main():
    ...
    # print(thingy.figureOutAllNumbers())

    print(thingy.nextBeautifulNumber(1)) # 22
    print(thingy.nextBeautifulNumber(1000)) # 1333
    print(thingy.nextBeautifulNumber(3000)) # 3133
    # print(thingy.nextBeautifulNumber()) # 
    # print(thingy.nextBeautifulNumber()) # 
